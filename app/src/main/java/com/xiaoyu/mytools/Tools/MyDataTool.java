...
import static com.xiaoyu.mytools.Tools.MyConstTool.BYTE;
import static com.xiaoyu.mytools.Tools.MyConstTool.GB;
import static com.xiaoyu.mytools.Tools.MyConstTool.KB;
import static com.xiaoyu.mytools.Tools.MyConstTool.MB;
...
public class MyDataTool {
     ...
     * @param byteNum 字节数
     * @param unit    <ul>
     *                <li>{@link MyConstTool.MemoryUnit#BYTE}: 字节</li>
     *                <li>{@link MyConstTool.MemoryUnit#KB}  : 千字节</li>
     *                <li>{@link MyConstTool.MemoryUnit#MB}  : 兆</li>
     *                <li>{@link MyConstTool.MemoryUnit#GB}  : GB</li>
     *                </ul>
     * @return 以unit为单位的size
     */
    public static double byte2Size(long byteNum, MyConstTool.MemoryUnit unit) {
     ...
     * @return 字节数
     */
    public static long size2Byte(long size, MyConstTool.MemoryUnit unit) {
        if (size < 0) return -1;
        switch (unit) {
            default:
            case BYTE:
