...
import static com.xiaoyu.mytools.Tools.MyDataTool.bytes2HexString;
import static com.xiaoyu.mytools.Tools.MyDataTool.hexString2Bytes;
...
public class MyEncryptTool {
    ...
    public static byte[] encryptDES2Base64(byte[] data, byte[] key) {
        return MyEncodeTool.base64Encode(encryptDES(data, key));
    }
    ...
    public static byte[] decryptBase64DES(byte[] data, byte[] key) {
        return decryptDES(MyEncodeTool.base64Decode(data), key);
    }
    ...
    public static byte[] encrypt3DES2Base64(byte[] data, byte[] key) {
        return MyEncodeTool.base64Encode(encrypt3DES(data, key));
    }
    ...
    public static byte[] decryptBase64_3DES(byte[] data, byte[] key) {
        return decrypt3DES(MyEncodeTool.base64Decode(data), key);
    }
    ...
    public static byte[] encryptAES2Base64(byte[] data, byte[] key) {
        return MyEncodeTool.base64Encode(encryptAES(data, key));
    }
    ...
    public static byte[] decryptBase64AES(byte[] data, byte[] key) {
        return decryptAES(MyEncodeTool.base64Decode(data), key);
    }
