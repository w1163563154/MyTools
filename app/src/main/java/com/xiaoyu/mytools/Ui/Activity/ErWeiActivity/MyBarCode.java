...
public class MyBarCode {
     ...
     *
     * @param text 样式字符串文本
     * @return {@link MyBarCode.Builder}
     */
    public static MyBarCode.Builder builder(@NonNull CharSequence text) {
        return new MyBarCode.Builder(text);
    }
    ...
    public static class Builder {
        ...
        public Bitmap into(ImageView imageView) {
            Bitmap bitmap = MyBarCode.createBarCode(content, codeWidth, codeHeight, backgroundColor, codeColor);
            if (imageView != null) {
